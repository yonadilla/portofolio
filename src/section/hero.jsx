    ...
    <div>
      <div className="  flex flex-col py-10 mt-5  justify-center lg:items-center lg:mt-0 lg:justify-center lg:py-28">
        <div className=" flex flex-col text-center justify-center items-center lg:w-1/2">
          <div className=" text-white text-2xl  h-48">
          <Typewriter
                options={{
                  delay:60,
                  pauseFor : 100 ,
                ...
                onInit={(typewritter) => {
                  typewritter.typeString("<strong>halo aku Yon, seorang <span style='color : #C778DD;'>Front-end web developer</span><span style='font-size: 14px ; color:#ABB2BF '><br>belajar secara otodidak adalah jalan ninjaku</span></span>")
                  .callFunction(() => {
